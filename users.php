    ...
    <body class="mod-bg-1 mod-nav-link">
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            ...
            <div class="row" id="js-contacts">
                <?php $email = get_user_by_email_or_id("register");
                foreach ($email as $value): ?>
                <div class="col-xl-4">
                    <div id="c_2" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php echo $value['Name']; ?>">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">

                            <div class="d-flex flex-row align-items-center">
                                    <?php if ($value['status'] == "online") :?>
                                    <span class="status status-success mr-3"> <a href="page_profile.php?id=<?=$value['id'];?>">
                                            <span class="rounded-circle profile-image d-block"
                                                  style="background-image:url('/img/avatar/<?php echo $value['img_avatar']?>');
                                                          background-size: cover;"></span></span>
                                    <?php elseif ($value['status'] == "away") :?>
                                    <span class="status status-warning mr-3"> <a href="page_profile.php?id=<?=$value['id'];?>">
                                            <span class="rounded-circle profile-image d-block"
                                                  style="background-image:url('/img/avatar/<?php echo $value['img_avatar']?>');
                                                          background-size: cover;"></span></span>
                                    <?php elseif ($value['status'] == "busy") :?>
                                    <span class="status status-danger mr-3"> <a href="page_profile.php?id=<?=$value['id'];?>">
                                            <span class="rounded-circle profile-image d-block"
                                                  style="background-image:url('/img/avatar/<?php echo $value['img_avatar']?>');
                                                          background-size: cover;"></span></span>
                                    <?php endif; ?>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="<?php echo $value['telephon']; ?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mobile-alt text-muted mr-2"></i> <?php echo $value['telephon']; ?></a>
                                <a href="mailto:oliver.kopyov@smartadminwebapp.com" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mouse-pointer text-muted mr-2"></i> <?php echo $value['email']; ?></a>
                                <address class="fs-sm fw-400 mt-4 text-muted">
                                    <i class="fas fa-map-pin mr-2"></i> <?php echo $value['adres']; ?></address>
                                <div class="d-flex flex-row">
                                    <a href="https://vk.com/<?php echo $value['vk']; ?>" class="mr-2 fs-xxl" style="color:#4680C2">
                                        <i class="fab fa-vk"></i>
                                    </a>
                                    <a href="https://https://web.telegram.org/<?php echo $value['telegram']; ?>" class="mr-2 fs-xxl" style="color:#38A1F3">
                                        <i class="fab fa-telegram"></i>
                                    </a>
                                    <a href="https://instagram.com/<?php echo $value['instagram']; ?>" class="mr-2 fs-xxl" style="color:#E1306C">
