...
if (!check_admin() and !is_author($_SESSION['id'], $open_user_id)) {
    set_flash_message("danger", "Уважаемый! Это не Ваш профиль!");
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput" class="form-control" name="position" value="<?php echo $user['position']; ?>">
                                </div>

                                <!-- tel -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Номер телефона</label>
                                    <input type="text" id="simpleinput" class="form-control" name="telephon" value="<?php echo $user['telephon']; ?>">
                                </div>

                                <!-- address -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Адрес</label>
                                    <input type="text" id="simpleinput" class="form-control" name="adres" value="<?php echo $user['adres']; ?>">
                                </div>
